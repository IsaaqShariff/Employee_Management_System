...
class Print_Data implements ActionListener{
    JFrame f;
    JLabel aid20,id8,id,aid,id1,aid1,id2,aid2,id3,aid3,id4,aid4,id5,aid5,id6,aid6,id7,aid7,id9,id10,id11,id12,id13,id14,id15,id16,id17,id30,lab;
    ...
    Print_Data(String e_id){
        ...
        id30.setBounds(100,460,200,30);
        id30.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id30);

        aid20= new JLabel(post);
        aid20.setBounds(300,460,300,30);
        aid20.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid20);
