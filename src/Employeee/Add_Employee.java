...
class Add_Employee implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,id16,id17,id27,lab,lab1;
    JTextField t,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t20;
    JButton b,b1,b2,b3;
    ...
    Add_Employee(){
        ...
        id27= new JLabel("Department Name");
        id27.setBounds(400,400,190,30);
        id27.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id27);

        t20=new JTextField();
        t20.setBounds(600,400,150,30);
        id15.add(t20);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String l = t20.getText();
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"')";
                cc.s.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"Trigger2:Details Successfully Inserted into Employee!");
                f.setVisible(false);
                new details();
            }catch(Exception ee){
