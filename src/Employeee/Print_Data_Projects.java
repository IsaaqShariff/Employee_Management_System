...
class Print_Data_Projects implements ActionListener{
    JFrame f;
    ...
    String emp_id,name,father,address,phone,email,education,post,age,dob,aadhar,project_id,project_name,project_desc,Employee_ID,Employee_name,project_status;
    JButton b1,b2;
    ImageIcon icon;

    Print_Data_Projects(String e_id){
        try{
            conn con = new conn();
            String str = "select * from projects where project_id = '"+e_id+"'";
            ...
            while(rs.next()){
                ...
                project_status = rs.getString("status");
        ...
        id.setBounds(100,70,120,30);
        id.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id);

        aid = new JLabel(project_id);
        aid.setBounds(250,70,200,30);
        aid.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid);

        id1 = new JLabel("Project Name:");
        id1.setBounds(100,120,150,30);
        id1.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id1);

        aid1 = new JLabel(project_name);
        aid1.setBounds(250,120,300,30);
        aid1.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid1);

  
        id2 = new JLabel("Project Description:"); 
        id2.setBounds(100,170,200,30);
        id2.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id2);

        aid2 = new JLabel(project_desc);
        aid2.setBounds(300,170,300,30);
        aid2.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid2);

        id3= new JLabel("Employee ID:");
        id3.setBounds(100,220,150,30);
        id3.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id3);

        aid3= new JLabel(Employee_ID);
    ...
    public static void main(String[] args){
        new Print_Data_Projects("Print_Data_Projects");
    }
